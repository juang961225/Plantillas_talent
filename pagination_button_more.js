//http://boo1.neuvoo.com/boo3-web/spider/add-step.php?style=dark&id=194745 <---- spider de prueba

//extract simple
(function() {
	var out = {};
     var html_jobs = document.querySelectorAll(".data-row.clickable");
  	var jobs = [];for(var x in html_jobs){
    	if(typeof html_jobs[x] =="function") continue;
      	if(typeof html_jobs[x] =="number") continue;
    	var job = {};
    	var elem = html_jobs[x];
    	job.title = elem.querySelector(".jobTitle-link").textContent.trim();
    	job.url = elem.querySelector(".jobTitle-link").href.trim();
		...
		job.source_salary = elem.querySelector(".jobFacility").textContent.trim();
       	job.temp = 1;
    	jobs.push(job);
  	} 
